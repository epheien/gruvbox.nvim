...
local function get_groups()
  ...
  local groups = {
    ...
    CocInfoSign = { link = "GruvboxYellowSign" },
    CocHintSign = { link = "GruvboxBlueSign" },
    CocErrorFloat = { link = "GruvboxRed" },
    CocWarningFloat = { link = "GruvboxOrange" },
    CocInfoFloat = { link = "GruvboxYellow" },
    CocHintFloat = { link = "GruvboxBlue" },
    CocDiagnosticsError = { link = "GruvboxRed" },
    CocDiagnosticsWarning = { link = "GruvboxOrange" },
    CocDiagnosticsInfo = { link = "GruvboxYellow" },
    CocDiagnosticsHint = { link = "GruvboxBlue" },
